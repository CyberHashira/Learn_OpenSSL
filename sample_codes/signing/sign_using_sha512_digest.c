/*      This is a hobby project shared for learning purposes under the MIT License.
        ...
        OBJECTIVE:
        - This example code demonstrates how to sign data using OpenSSL API.
	- It uses SHA2-512 digest algorithm to calculate the digest.
	- Depending on the private key used, the resulting signature will either be sha512WithRSA or sha512WithECDSA.
...
void signData()
{
	...
	EVP_DigestSignInit(mdCtx, NULL, EVP_sha512(), NULL, signingKey);
