/*      This is a hobby project shared for learning purposes under the MIT License.
        ...
        OBJECTIVE:
	- This sample demonstrates how to encrypt a plaintext using rsa-pkcs1 mechanism.
...
void encryptData()
{
	...
	EVP_PKEY_CTX_set_rsa_padding(encCtx, RSA_PKCS1_PADDING);
...
void decryptData()
{
	...
	EVP_PKEY_CTX_set_rsa_padding(decCtx, RSA_PKCS1_PADDING);
