/*
	...
	2. Encrypt a text using pkcs1 padded rsa algorithm.
...
// Encrypts plaintext using RSA-PKCS1 padding.
void encryptData()
{
	...
	EVP_PKEY_CTX_set_rsa_padding(encCtx, RSA_PKCS1_PADDING); // Setting padding mode.
...
// Decrypts encrypted text using RSA_PKCS1 padding.
void decryptData()
{
	...
	EVP_PKEY_CTX_set_rsa_padding(decCtx, RSA_PKCS1_PADDING); // Setting padding mode.
